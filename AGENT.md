...
- **Do not commit plans**: Plans created in `.agents_tmp/` (e.g., `PLAN.md`) should never be
  committed. They are temporary working documents for the AI agent and should remain local-only.
